...
public class SimplePlayer : MonoBehaviour
{
    ...
    public void Damage(int amount)
    {
        ...
        BleedBehavior.minBloodAmount = maxBloodIndication * (maxHP - HP) / maxHP;
        Debug.LogError("Blood: " + BleedBehavior.BloodAmount + " " + BleedBehavior.BloodAmount);
    }

    public void DamageT(int amount)
    {
        BleedBehavior.BloodAmount    = 0.2f;
        BleedBehavior.minBloodAmount = 0.2f;
